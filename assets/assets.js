...
import mattress_hero_image from "./mattress_hero_image.svg";
import bed_frame_hero_image from "./bed_frame_hero_image.svg";
import bedroom_set_hero_image from "./bedroom_set_hero_image.svg";
import hero_bed_1 from "./beds_1.png";
import hero_bed_2 from "./beds_2.png";
import hero_bed_3 from "./beds_3.png";
import bed_layer from "./bed_layer.png";
import air_flow from "./air_flow.webp";
import side_pain from "./side_pain.png";
import surface from "./surface.webp";
import sleep_side from "./sleep_side.webp";
import bed_full from "./bed_k.png";
import baner_pillow from "./pillows.png";
import baner_pillow2 from "./pillows2.png";
import featured1 from "./featured1.png";
import featured2 from "./featured2.png";
import featured3 from "./featured3.png";
import featured11 from "./featured11.png";
import shopslider1 from "./shopheader1.png";
import shopslider2 from "./shopheader2.png";
import shopslider3 from "./shopheader3.png";
import shopslider4 from "./shopheader4.png";
import shopslider5 from "./shopheader5.png";
import shopslider6 from "./shopheader6.png";
import comfirt from "./comfirt.webp";
import cooling from "./cooling.webp";
import motion from "./motions.webp";
import orthopedic from "./orthopedic.webp";
import new_abaya_hero_1 from "./new_abaya_hero_1.png";
import new_abaya_hero_2 from "./new_abaya_hero_2.png";
import abaya_lifestyle from "./abaya_lifestyle.png";
import timeless_elegance_abaya from "./timeless_elegance_abaya.png";
import shipping_luxury_abaya from "./shipping_luxury_abaya.png";
import returns_luxury_abaya from "./returns_luxury_abaya.png";
import faq_luxury_abaya from "./faq_luxury_abaya.png";
import privacy_luxury_abaya from "./privacy_luxury_abaya.png";
import journal_hero from "./journal_hero.png";
...
export const assets = {
  ...
  mattress_hero_image,
  bed_frame_hero_image,
  bedroom_set_hero_image,
  hero_bed_1,
  hero_bed_2,
  hero_bed_3,
  checkmark,
  ...
  new_abaya_hero_2,
  abaya_lifestyle,
  timeless_elegance_abaya,
  shipping_luxury_abaya,
  returns_luxury_abaya,
  faq_luxury_abaya,
  privacy_luxury_abaya,
  journal_hero
};
...
export const productsDummyData = [
  {
    _id: "abaya_1",
    userId: "admin",
    name: "Classic Silk Abaya",
    description: "Flowing silk abaya in deep emerald green, perfect for formal occasions.",
    price: 350.00,
    offerPrice: 299.00,
  ...
  },
  {
    ...
    description: "Elegant black abaya with delicate lace detailing on sleeves and hem.",
    price: 420.00,
    offerPrice: 380.00,
  ...
  },
  {
    _id: "dress_1",
    userId: "admin",
    name: "Satin Under-Abaya Dress",
    description: "Smooth satin inner dress designed to complement any open abaya.",
    price: 150.00,
    offerPrice: 120.00,
  ...
  },
  {
    _id: "suit_1",
    userId: "admin",
    name: "Linen Modest Suit",
    description: "Three-piece linen suit in beige, combining comfort with modern modesty.",
    price: 499.00,
    offerPrice: 450.00,
    image: [assets.featured11],
    category: "Suit",
    date: Date.now(),
    __v: 0,
  },
